...
var SimpleForm = function (_a) {
    ...
    return (_jsxs(Stack, __assign({ as: "form", onSubmit: handleSubmit(onSubmit), gridGap: "0.5rem", "data-testid": "protochakra.simpleForm", noValidate: true }, { children: [fields.map(function (field, i) {
                var _a;
                if (!field.name)
                    throw new Error('name property missing for field');
                return (_jsxs(FormControl, __assign({ isRequired: field === null || field === void 0 ? void 0 : field.isRequired, isInvalid: !!(errors === null || errors === void 0 ? void 0 : errors[field.name]), marginTop: "1rem", "data-testid": "protochakra.simpleForm.control" }, { children: [(field === null || field === void 0 ? void 0 : field.label) && _jsx(FormLabel, __assign({ "data-testid": "protochakra.simpleForm.label" }, { children: field.label })), _jsx(FormField, __assign({ type: field === null || field === void 0 ? void 0 : field.type, selectOptions: field === null || field === void 0 ? void 0 : field.selectOptions, placeholder: field === null || field === void 0 ? void 0 : field.placeholder, "data-testid": "protochakra.simpleForm.field" }, register(field.name, { required: field === null || field === void 0 ? void 0 : field.isRequired }), field)), _jsx(FormErrorMessage, __assign({ "data-testid": "protochakra.simpleForm.error" }, { children: getFormError((_a = errors === null || errors === void 0 ? void 0 : errors[field.name]) === null || _a === void 0 ? void 0 : _a.type) })), (field === null || field === void 0 ? void 0 : field.helperText) && (_jsx(FormHelperText, __assign({ "data-testid": "protochakra.simpleForm.helper" }, { children: field.helperText })))] }), i));
