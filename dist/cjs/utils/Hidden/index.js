...
exports.mergeBooleanArrays = exports.arrayToDisplay = void 0;
...
var arrayToDisplay = function (property, defaultDisplay) {
    return property.map(function (value) { return (value ? 'none' : defaultDisplay); });
};
exports.arrayToDisplay = arrayToDisplay;
var mergeBooleanArrays = function (first, second) {
...
exports.mergeBooleanArrays = mergeBooleanArrays;
