...
var DataTable = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_1.Table, __assign({ "data-testid": "protochakra.dataTable" }, getTableProps(), { children: [(0, jsx_runtime_1.jsx)(react_1.Thead, { children: headerGroups.map(function (headerGroup) { return ((0, jsx_runtime_1.jsx)(react_1.Tr, __assign({}, headerGroup.getHeaderGroupProps(), { children: headerGroup.headers.map(function (column) { return ((0, jsx_runtime_1.jsxs)(react_1.Th, __assign({}, column.getHeaderProps(column.getSortByToggleProps()), { isNumeric: column.isNumeric }, { children: [column.render('Header'), (0, jsx_runtime_1.jsx)(react_1.chakra.span, __assign({ pl: "4" }, { children: column.isSorted ? (column.isSortedDesc ? ((0, jsx_runtime_1.jsx)(icons_1.TriangleDownIcon, { "aria-label": "sorted descending" }, void 0)) : ((0, jsx_runtime_1.jsx)(icons_1.TriangleUpIcon, { "aria-label": "sorted ascending" }, void 0))) : null }), void 0)] }), void 0)); }) }), void 0)); }) }, void 0), (0, jsx_runtime_1.jsx)(react_1.Tbody, __assign({}, getTableBodyProps(), { children: rows.map(function (row) {
                    prepareRow(row);
                    return ((0, jsx_runtime_1.jsx)(react_1.Tr, __assign({}, row.getRowProps(), { children: row.cells.map(function (cell) { return ((0, jsx_runtime_1.jsx)(react_1.Td, __assign({}, cell.getCellProps(), { isNumeric: cell.column.isNumeric }, { children: cell.render('Cell') }), void 0)); }) }), void 0));
                }) }), void 0)] }), void 0));
};
