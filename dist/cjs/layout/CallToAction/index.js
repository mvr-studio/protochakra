...
var CallToAction = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_1.Box, __assign({ paddingY: "2rem", "data-testid": "protochakra.cta" }, containerProps, { children: (0, jsx_runtime_1.jsx)(react_1.Container, __assign({ maxWidth: maxWidth || 'container.xl' }, { children: (0, jsx_runtime_1.jsxs)(react_1.Flex, __assign({ display: ['block', 'block', 'flex'], justify: "space-between", align: "center" }, { children: [(0, jsx_runtime_1.jsxs)(react_1.Box, { children: [(0, jsx_runtime_1.jsx)(react_1.Heading, __assign({ size: "lg", "data-testid": "protochakra.cta.heading" }, { children: heading })), description && ((0, jsx_runtime_1.jsx)(react_1.Text, __assign({ marginTop: "1rem", "data-testid": "protochakra.cta.description" }, { children: description })))] }), (0, jsx_runtime_1.jsx)(react_1.Box, __assign({ marginTop: ['2rem', '2rem', 0], "data-testid": "protochakra.cta.addons" }, { children: children }))] })) })) })));
};
