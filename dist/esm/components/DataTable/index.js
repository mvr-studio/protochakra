...
var DataTable = function (_a) {
    ...
    return (_jsxs(Table, __assign({ "data-testid": "protochakra.dataTable" }, getTableProps(), { children: [_jsx(Thead, { children: headerGroups.map(function (headerGroup) { return (_jsx(Tr, __assign({}, headerGroup.getHeaderGroupProps(), { children: headerGroup.headers.map(function (column) { return (_jsxs(Th, __assign({}, column.getHeaderProps(column.getSortByToggleProps()), { isNumeric: column.isNumeric }, { children: [column.render('Header'), _jsx(chakra.span, __assign({ pl: "4" }, { children: column.isSorted ? (column.isSortedDesc ? (_jsx(TriangleDownIcon, { "aria-label": "sorted descending" }, void 0)) : (_jsx(TriangleUpIcon, { "aria-label": "sorted ascending" }, void 0))) : null }), void 0)] }), void 0)); }) }), void 0)); }) }, void 0), _jsx(Tbody, __assign({}, getTableBodyProps(), { children: rows.map(function (row) {
                    prepareRow(row);
                    return (_jsx(Tr, __assign({}, row.getRowProps(), { children: row.cells.map(function (cell) { return (_jsx(Td, __assign({}, cell.getCellProps(), { isNumeric: cell.column.isNumeric }, { children: cell.render('Cell') }), void 0)); }) }), void 0));
                }) }), void 0)] }), void 0));
};
